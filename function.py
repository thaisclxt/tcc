...
class Function:
    ...
    def __init__(self, is_user_input: bool, expression: Expr, global_minimun: np.ndarray):
        ...
        """Verifica se a função `f(x,y)` foi digitada pelo usuário ou se foi excolhida entre as funções de exemplo do TCC 1."""

        self.expression = expression
        """È a função de entrada em formato de uma expressão SymPy."""

        self.global_minimun = global_minimun
        """É o ponto de mpinimo global da função f(x,y)."""
